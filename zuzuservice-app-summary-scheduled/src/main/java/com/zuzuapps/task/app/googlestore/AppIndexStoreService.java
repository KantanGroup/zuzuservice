...
public class AppIndexStoreService extends AppCommonService {
    ...
    private void createAppTrendInSearchEngine(List<GoogleAppTrendSolr> appTrends, String countryCode, CategoryEnum category, CollectionEnum collection, int index, SummaryApplicationGooglePlay app) {
